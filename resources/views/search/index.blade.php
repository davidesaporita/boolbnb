    ...
    <section class="wrap-search">
        ...
        <div class="filter-menu">
            <div id="filterTitle" class="filter-title">
                <div class="container">
                    <h5>Filtri</h5><i id="filterShowButtonIcon" class="fas fa-plus-circle"></i>
                </div>
            </div>
            <div id="dropDownFilter" class="dropdown-filter hidden">
                <div class="container">
        ...
        <div id="search-map" class="rounded-lg"></div>
